...
class game:
    ...
    def get_shot_X_coord(self, theList):
    ...
    def get_shot_Y_coord(self, theList):
        momentlist = self.moments
        momentCount = 0
        listCount = 0
    ...
    def get_shot_Z_coord(self, theList):
        momentlist = self.moments
        momentCount = 0
        listCount = 0
    ...
    def get_shot_coord(self, theList):
        momentlist = self.moments
        momentCount = 0
        listCount = 0
...
if __name__ == "__main__":
    main(sys.argv[1:])
    g1 = game("0021500423", True, True)
    s1 = g1.get_list_of_shots()         # Gets player name, id, team, quarter, start_t, end_t, and outcome of each shot
    # print(s1)
    ...
    ax.scatter(s2, s3, s4, c='r', marker='o')
    plt.show()
